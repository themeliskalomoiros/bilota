class Queue:
    ...
    Items in a Queue are added to the back and removed from the front. (FIFO)
    """
    def __init__(self):
        self.items = []
    ...
    def enqueue(self, item):
        ...
        of a list forces all the other items in the list to move one index to
        the right.
        """
    ...
    def peek(self):
        ...
        The runtime is O(1), or constant time, because we're just indexing to
